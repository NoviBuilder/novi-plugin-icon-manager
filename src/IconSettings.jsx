...
export default class IconSettings extends Component {
    constructor(props) {
        ...
        this.messages = Language.getDataByKey("novi-plugin-icon-manager");
    }
    ...
    render() {
        return (
            <div>
                <span style={{letterSpacing: "0,0462em"}}>Icon Plugin</span>
    ...
    saveSettings(){
        novi.plugins.settings.update("novi-plugin-icon-manager", this.state.settings);
    }
}